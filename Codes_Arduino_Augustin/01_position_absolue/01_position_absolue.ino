...
Vect3D point_plus_proche(const Vect3D& C1, const Vect3D& D1,
                         const Vect3D& C2, const Vect3D& D2) {
  Vect3D r = {C2.x - C1.x, C2.y - C1.y, C2.z - C1.z};
  ...
  Vect3D P1 = {C1.x + s*D1.x, C1.y + s*D1.y, C1.z + s*D1.z};
  Vect3D P2 = {C2.x + t*D2.x, C2.y + t*D2.y, C2.z + t*D2.z};
